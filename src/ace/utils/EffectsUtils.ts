...
module utils {
    ...
    export class EffectsUtils {
         ...
         */
        public static twinkle(display, type:number = 1, delay:number = 1000):void {
         ...
         * @param delay 间隔(单位:毫秒)
         */
        public static scaling(display, type:number = 1, delay:number = 1000):void {
            if (display == null) return;
         ...
         * @param delay 间隔(单位:毫秒)
         */
        public static turning(display, type:number = 1, delay:number = 1000):void {
            if (display == null) return;
         ...
         */
        public static floating(display, type:number = 1, delay:number = 50, spacing:number = 50):void {
            if (display == null) return;
         ...
         */
        public static shaking(display, type:number = 1, delay:number = 50, spacing:number = 20):void {
            if (display == null) return;
