...
module utils {
    ...
    export class TextEffectsUtils {
        ...
        public static showTipsDownToUp(str:string = "", isWarning:boolean = false):void {
            ...
            if (isWarning) {
                effectTips.textColor = config.Color.red;
            } else {
                effectTips.textColor = config.Color.green;
            }
            effectTips.alpha = 0;
            ...
            if (!game.stage.contains(effectTips)) {
                game.stage.addChild(effectTips);
            }

            var onComplete2:Function = function () {
                if (game.stage.contains(effectTips)) {
                    game.stage.removeChild(effectTips);
                    effectTips = null;
                }
            };
