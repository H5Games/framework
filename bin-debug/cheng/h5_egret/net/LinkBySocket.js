...
(function (net) {
    var LinkBySocket = (function () {
        ...
        p.onReceive = function (e) {
            net.Link.getInstance().dispatchEvent(net.Link.Receive_Complete);
        };
        p.onConnect = function (e) {
            net.Link.getInstance().dispatchEvent(net.Link.Connect_Complete);
        };
    ...
    net.LinkBySocket = LinkBySocket;
    egret.registerClass(LinkBySocket,'net.LinkBySocket');
})(net || (net = {}));
